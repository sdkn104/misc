...
from data_agents.agent_utils import extract_json_objects, generate_data_summary, extract_code_from_gpt_response
import data_agents.py_sandbox as py_sandbox
...
SYSTEM_PROMPT = r'''You are a data scientist to help user to recommend data that will be used for visualization.
...
d:\NoSync\my-data-formulator\py-src\data_formulator\agents\agent_interactive_explore.py
{
...
Concretely:
    ...
    - If the user's [GOAL] is clear already, simply infer what the user mean. Set "mode" as "infer" and create "output_fields" and "vega_lite" based off user description.
