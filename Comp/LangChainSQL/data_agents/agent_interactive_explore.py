...
from data_agents.agent_utils import extract_json_objects, generate_data_summary
...
8. FORMATTING: for each question, include a 'goal' that concisely summarizes the essence of the question, and 'instruction' that is a prompt to visualize for the question. 
...
questionとgoalとinstructionは日本語で記述してください。

Format:

data: {"type": "question", "text": ..., "goal": ..., "instruction": ..., "difficulty": ..., "tag": ...} 
data: {"type": "question", "text": ..., "goal": ..., "instruction": ..., "difficulty": ..., "tag": ...} 
... // more questions
'''
