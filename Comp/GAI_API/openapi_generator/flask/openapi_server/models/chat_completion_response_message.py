...
class ChatCompletionResponseMessage(Model):
    ...
    def __init__(self, content=None, refusal=None, tool_calls=None, annotations=None, role=None, function_call=None, audio=None):  # noqa: E501
        ...
        :param annotations: The annotations of this ChatCompletionResponseMessage.  # noqa: E501
    ...
    def annotations(self) -> List[ChatCompletionResponseMessageAnnotationsInner]:
        """Gets the annotations of this ChatCompletionResponseMessage.
        ...
        :return: The annotations of this ChatCompletionResponseMessage.
    ...
    def annotations(self, annotations: List[ChatCompletionResponseMessageAnnotationsInner]):
        """Sets the annotations of this ChatCompletionResponseMessage.

        Annotations for the message, when applicable, as when using the [web search tool](/docs/guides/tools-web-search?api-mode=chat).   # noqa: E501

        :param annotations: The annotations of this ChatCompletionResponseMessage.
        :type annotations: List[ChatCompletionResponseMessageAnnotationsInner]
        """
